...
import com.sun.demo.service.impl.MqttServiceImpl;
...
public class MqttConfig {
    ...
    public MessageProducer inbound() {
        ...
        // 可以同时消费（订阅）多个Topic
        MqttPahoMessageDrivenChannelAdapter adapter = new MqttPahoMessageDrivenChannelAdapter("re" + clientcId, senderMqttClientFactory(),receiverTopics);
    ...
    public MessageHandler handler() {
        MqttServiceImpl service = new MqttServiceImpl();
        return service;
    }
}
